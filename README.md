...
| **AI / ML** | TensorFlow, Keras, Computer Vision, Edge AI |
| **LLM & GenAI** | Ollama, LangChain, Prompt Engineering, Stable Diffusion |
| **Tools** | Docker, Git, Google Colab, Kaggle, VS Code, Linux |
| **Web** | Tailwind CSS, HTML, CSS, Node.js |
| **Database** | SQL, PostgreSQL, SQLite |
| **DevOps** | Self-Hosting, Nextcloud, DDNS, Reverse Proxy |
| **Data Formats** | JSON, XML, YAML, Markdown, TOML |
